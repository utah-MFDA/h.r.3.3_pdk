 ...
 * center_chambers: boolean, center chambers depthwise or align
...
module optical_view(xpos, ypos, zpos, orientation,
   ...
   chan_w=10, chan_h=14, shape="cube", center_chambers=false)
{
    // path defs
    ...
    module obj()
    {
        ...
        f_dimm = [i_dimm[0], i_dimm[1], i_dimm[2]+(num_of_ch-1)*d_depth] ;
            f_pt =
             [(r_ch*2+d_ch_distance)*(num_of_ch-1)+r_ch-i_dimm[0]/2, 0, center_chambers?i_dimm[2]/2:f_dimm[2]/2] ;
...
optical_view(0,0,0,"E", center_chambers=true) ;
